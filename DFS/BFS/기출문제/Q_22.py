    ...
    while (q):
        ...
        if boat_left_i - 1 >= 0 and boat_right_i - 1 >= 0:
            if board[boat_left_i - 1][boat_left_j] != 1 and board[boat_right_i - 1][boat_right_j] != 1:
                if not ((boat_left_i - 1, boat_left_j),(boat_right_i - 1, boat_right_j)) in history:
                    history.append(((boat_left_i - 1, boat_left_j),(boat_right_i - 1, boat_right_j)))
                    q.append((
        ...
        if boat_left_j - 1 >= 0 and boat_right_j - 1 >= 0:
            if board[boat_left_i][boat_left_j - 1] != 1 and board[boat_right_i][boat_right_j - 1] != 1:
                if not ((boat_left_i, boat_left_j - 1),(boat_right_i, boat_right_j - 1)) in history:
                    history.append(((boat_left_i, boat_left_j - 1),(boat_right_i, boat_right_j - 1)))
                    q.append((
        ...
        # 오른쪽으로 이동
        if boat_left_j + 1 < len(board) and boat_right_j + 1 < len(board):
            if board[boat_left_i][boat_left_j + 1] != 1 and board[boat_right_i][boat_right_j + 1] != 1:
                if not ((boat_left_i, boat_left_j + 1),(boat_right_i, boat_right_j + 1)) in history:
                    history.append(((boat_left_i, boat_left_j + 1),(boat_right_i, boat_right_j + 1)))
                    q.append((
        ...
        if boat_left_i == boat_right_i:
            ...
            if boat_right_i + 1 < len(board) and boat_right_j - 1 >= 0:
                if board[boat_left_i + 1][boat_left_j] != 1 and board[boat_right_i + 1][boat_right_j] != 1:
                    if not ((boat_left_i, boat_left_j),(boat_right_i + 1, boat_right_j - 1)) in history:
                        history.append(((boat_left_i, boat_left_j),(boat_right_i + 1, boat_right_j - 1)))
                        q.append((
            ...
            if boat_right_i - 1 >= 0 and boat_right_j - 1 >= 0:
                if board[boat_left_i - 1][boat_left_j] != 1 and board[boat_right_i - 1][boat_right_j] != 1:
                    if not ((boat_right_i - 1, boat_right_j - 1),(boat_left_i, boat_left_j)) in history:
                        history.append(((boat_right_i - 1, boat_right_j - 1),(boat_left_i, boat_left_j)))
                        q.append((
            ...
            if boat_left_i + 1 < len(board) and boat_left_j + 1 < len(board):
                if board[boat_left_i + 1][boat_left_j] != 1 and board[boat_right_i + 1][boat_right_j] != 1:
                    if not ((boat_right_i, boat_right_j),(boat_left_i + 1, boat_left_j + 1)) in history:
                        history.append(((boat_right_i, boat_right_j),(boat_left_i + 1, boat_left_j + 1)))
                        q.append((
            ...
            # 오른쪽 기준 대각선 위로 이동
            if boat_left_i - 1 >= 0 and boat_left_j + 1 < len(board):
                if board[boat_left_i - 1][boat_left_j] != 1 and board[boat_right_i - 1][boat_right_j] != 1:
                    if not ((boat_left_i - 1, boat_left_j + 1),(boat_right_i, boat_right_j)) in history:
                        history.append(((boat_left_i - 1, boat_left_j + 1),(boat_right_i, boat_right_j)))
                        q.append((
