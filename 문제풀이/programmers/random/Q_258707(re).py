...
def solution(coin, cards):
    ...
    def find_and_remove_card(set1, set2):
    ...
    while idx < len(deck):
        ...
        if find_and_remove_card(hand, hand):
            pass
        elif coin >= 1 and find_and_remove_card(hand, keep):
            coin -= 1
        elif coin >= 2 and find_and_remove_card(keep, keep):
            coin -= 2
        else:
            break
